...
import type { MarketData, RsiData, MacdData, BbandsData, RocData, IndicatorPeriods, MAVolData, VwmaData, ObvData, StochasticData, CmfData, EmaData, SmaData, CombinedAnalysisResult, MonteCarloResult } from '@/lib/types';

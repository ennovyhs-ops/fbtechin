...
const generateRationale = (strategyName: string, isBullish: boolean): string => {
    ...
    const rationales: Record<string, string> = {
        ...
        "Call Verticals": `A risk-defined bullish strategy suitable for moderate bullish outlooks. Involves buying a call at a lower strike and selling one at a higher strike to finance the position and cap potential profit and loss.`,
        ...
        "Call Credit Spreads": `A bearish, high-probability strategy where you expect the stock to stay below a certain price. You collect a premium (credit) by selling a call and buying a higher-strike call for protection. Best in moderate or high volatility.`,
        "Put Credit Spreads": `A bullish, high-probability strategy where you expect the stock to stay above a certain price. You collect a premium by selling a put and buying a lower-strike put for protection. Best in moderate or high volatility.`,

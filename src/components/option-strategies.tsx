            ...
            <div className="flex flex-col space-y-4">
                <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent>
                            <p className="max-w-xs">These suggestions are generated by a large language model (AI) which uses creative, pattern-based reasoning based on the momentum signal.</p>
                        </TooltipContent>
                    </Tooltip>
                </TooltipProvider>
             ...
             <div className="flex flex-col space-y-4">
                <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent>
                            <p className="max-w-xs">These suggestions are generated by a deterministic engine that follows a strict set of 'if-this-then-that' rules based on technical indicators like MACD and Bollinger Bands.</p>
                        </TooltipContent>
                    </Tooltip>
                </TooltipProvider>

            ...
            <div className="flex flex-col space-y-4">
                <TooltipProvider>
                    <Tooltip>
                        ...
                        <TooltipContent>
                            <p className="max-w-xs">These suggestions are generated by a large language model (AI). It acts as a creative strategist, providing a set of suitable ideas based on the momentum signal. Its suggestions are not ranked or prioritized.</p>
                        </TooltipContent>
                    </Tooltip>
                </TooltipProvider>

...
export function MomentumScoreExplanation() {
  return (
    <div className="mt-4 space-y-4 text-sm text-muted-foreground animate-in fade-in-50 duration-500">
      <p>
        The AI Momentum Score is a proprietary value calculated by analyzing four key technical indicators. Each indicator contributes points to a final score that ranges from -1.0 (strongly bearish) to +1.0 (strongly bullish).
      </p>
          ...
          <TableBody>
            <TableRow>
             ...
             <TableRow>
              ...
              <TableCell>Analyzes price vs. the 20-day SMA and checks for breakouts from squeezes or strong trends.</TableCell>
              <TableCell className="text-right">±0.3</TableCell>
            </TableRow>
             <TableRow>
              <TableCell>Relative Strength Index (RSI)</TableCell>

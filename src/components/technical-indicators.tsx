...
import { Loader2, AlertCircle, Activity, Target, TrendingUp, TrendingDown, Minus, AreaChart, RefreshCw, BarChart3 } from 'lucide-react';
import type { RsiData, MacdData, BbandsData, RocData, VwmaData, IndicatorPeriods } from '@/lib/types';
            ...
            <CardContent className="space-y-4">
                 <Tabs defaultValue="momentum" className="w-full">
                    ...
                    <div className="rounded-lg border mt-4">
                        <TabsContent value="momentum" className="m-0">
                                ...
                                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <Tooltip>
                                                <TooltipTrigger asChild>
                                                    <h3 className="font-semibold text-sm text-muted-foreground cursor-help underline decoration-dotted">Volume-Weighted Moving Average (VWMA)</h3>
                                                </TooltipTrigger>
                                                <TooltipContent side="top" align="start" className="max-w-xs">
                                                    <p className="font-bold mb-1">Volume-Weighted Moving Average (VWMA)</p>
                                                    <p>A moving average that gives more weight to prices with higher trading volume. It helps confirm if a price trend is backed by significant market participation.</p>
                                                    <p className="mt-2"><span className="font-semibold">Interpretation:</span> When the price is above the VWMA, it can indicate a bullish trend with strong conviction. When below, it can indicate a bearish trend.</p>
                                                </TooltipContent>
                                            </Tooltip>
                                            <p className="font-semibold text-lg">{formatCurrency(latestVwma?.VWMA, currency)}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center gap-2">
